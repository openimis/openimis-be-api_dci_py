...
from .views import sync_search, async_search, txn_status, DCILoginViewSet
...
urlpatterns = [
    ...
    # DCI Registry Core API endpoints
    path('reg/sync/search', sync_search, name='sync-search'),
    path('reg/search', async_search, name='async-search'),
    path('reg/txn/status', txn_status, name='txn-status'),
